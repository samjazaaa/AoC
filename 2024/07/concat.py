...
def is_solvable(equation):
    ...
    while True:
        ...
        if all(map(lambda v: v == 2, operands)):
            break

        increase_ternary(operands)

    return False


def calculate_concat(lines):
    cleared_lines = []
