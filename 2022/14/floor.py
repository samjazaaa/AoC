...
def drop_sand(cave, max_y):
    ...
    while sand_pos[1] < max_y+1:
        ...
        # nowhere to drop (check if it rests at start)
        cave[tuple(sand_pos)] = 'o'
        return False if sand_pos[0] == 500 and sand_pos[1] == 0 else True
...
def calculate_floor(lines):
    ...
    # add 1 for the last sand resting at spawn
    return resting+1
